...
export default function RightContact({ isOpen }: { isOpen: boolean }) {
  return (
    <motion.div
      ...
      className="fixed top-0 right-0 w-full lg:w-1/2 h-screen bg-black text-white z-50 border-l border-dashed border-cyan-400 p-8 flex flex-col justify-center"
    >
      {/* TITLE */}
