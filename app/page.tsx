...
export default function Home() {
  ...
  return (
    <main className="mt-[73px] h-[calc(100vh-137px)] w-full bg-transparent z-10 text-white overflow-hidden relative flex items-center justify-center">
      ...
      <motion.div 
        ...
        className="absolute left-4 md:left-12 top-1/2 -translate-y-1/2 hidden md:flex flex-col items-center gap-6 z-20 pointer-events-auto"
      >
        <a href="https://github.com" target="_blank" rel="noreferrer" className="text-cyan-400/60 hover:text-cyan-200 text-[10px] md:text-xs font-mono tracking-widest rotate-180 transition-colors duration-300 hover:drop-shadow-[0_0_8px_#22d3ee] cursor-pointer" style={{ writingMode: 'vertical-rl' }}>// GITHUB</a>
        <div className="w-[1px] h-12 bg-gradient-to-b from-transparent via-cyan-400/50 to-transparent" />
        <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="text-cyan-400/60 hover:text-cyan-200 text-[10px] md:text-xs font-mono tracking-widest rotate-180 transition-colors duration-300 hover:drop-shadow-[0_0_8px_#22d3ee] cursor-pointer" style={{ writingMode: 'vertical-rl' }}>// LINKEDIN</a>
        <div className="w-[1px] h-12 bg-gradient-to-b from-transparent via-cyan-400/50 to-transparent" />
        <a href="https://twitter.com" target="_blank" rel="noreferrer" className="text-cyan-400/60 hover:text-cyan-200 text-[10px] md:text-xs font-mono tracking-widest rotate-180 transition-colors duration-300 hover:drop-shadow-[0_0_8px_#22d3ee] cursor-pointer" style={{ writingMode: 'vertical-rl' }}>// X_CORP</a>
      </motion.div>
      ...
      <motion.div 
        ...
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.8, delay: 0.2 }}
        className="absolute right-4 md:right-12 top-1/2 -translate-y-1/2 hidden md:flex flex-col items-center gap-6 z-20 pointer-events-auto"
      >
        <button onClick={() => openPanel("about")} className="text-cyan-400/60 hover:text-cyan-200 text-[10px] md:text-xs font-mono tracking-widest transition-colors duration-300 hover:drop-shadow-[0_0_8px_#22d3ee] cursor-pointer" style={{ writingMode: 'vertical-rl' }}>[ DATABASE ]</button>
        <div className="w-[1px] h-12 bg-gradient-to-b from-transparent via-cyan-400/50 to-transparent" />
        <a href="mailto:contact@example.com" className="text-cyan-400/60 hover:text-cyan-200 text-[10px] md:text-xs font-mono tracking-widest transition-colors duration-300 hover:drop-shadow-[0_0_8px_#22d3ee] cursor-pointer" style={{ writingMode: 'vertical-rl' }}>[ COMMS ]</a>
        <div className="w-[1px] h-12 bg-gradient-to-b from-transparent via-cyan-400/50 to-transparent" />
        <button onClick={() => openPanel("contact")} className="text-cyan-400/60 hover:text-cyan-200 text-[10px] md:text-xs font-mono tracking-widest transition-colors duration-300 hover:drop-shadow-[0_0_8px_#22d3ee] cursor-pointer" style={{ writingMode: 'vertical-rl' }}>[ UPLINK ]</button>
      </motion.div>
      ...
      {/* 🧑‍💻 MAIN CONTENT */}
      <div className="relative z-10 text-center space-y-3 sm:space-y-6 px-2 md:px-6 w-full overflow-y-auto max-h-full pb-4 hide-scrollbar mb-10 md:mb-20">
        ...
        >
          <span className="px-3 md:px-4 py-1 border border-cyan-400/30 rounded-full text-[10px] md:text-xs tracking-[0.2em] text-cyan-300 bg-cyan-400/10 shadow-[0_0_15px_rgba(34,211,238,0.2)]">
            SYSTEM_ONLINE
          </span>
        </motion.div>

        {/* HUD IMAGE */}
        <div className="flex justify-center relative cursor-crosshair z-20 mt-4 lg:mt-8">
          <div className="relative w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 lg:w-80 lg:h-80 group p-1 md:p-2 lg:p-3">
        ...
        {/* ROLE */}
        <p className="text-cyan-200 tracking-wider md:tracking-widest lg:tracking-[0.3em] text-[9px] sm:text-sm md:text-base lg:text-lg lg:mt-2">
          MERN STACK DEVELOPER • NEXT.JS • AI
        </p>

        {/* BUTTONS */}
        <div className="flex gap-2 sm:gap-4 lg:gap-6 justify-center flex-wrap pt-2 lg:pt-6">

          {/* ABOUT */}
          <button
            onClick={() => openPanel("about")}
            className="px-4 py-1.5 md:px-6 md:py-2 lg:px-8 lg:py-3 text-[10px] md:text-base lg:text-sm lg:font-bold border border-dashed border-cyan-400 hover:bg-cyan-400/10 hover:shadow-[0_0_10px_#22d3ee] lg:hover:shadow-[0_0_20px_#22d3ee] transition-all"
          >
            ABOUT
          </button>
